        ...
        <tbody>
            <?php foreach($camapaigns['data'] as $ads) : 
                ...
                foreach ($ads['ads']['data'] as $key=> $ad) : 
                    ...
                    if(isset($ad['insights'])){ $total_impression+= $ad['insights']['data'][0]['impressions'];}
                    if(isset($ad['insights'])){ $total_unq_click+= $ad['insights']['data'][0]['unique_clicks'];} ?>
            <tr class="ad_rows camp_<?php echo $ads['id'];?> adsets_<?php echo $adsets[$key]['id'];?>" id="<?php echo $ad['id'];?>">
                ...
                <td>
                    <?php echo $ad['objective_for_results'];?>
                </td>
                <td>
                    <?php if(isset($ad['insights'])){echo $ad[ 'insights'][ 'data'][0][ 'reach'];}else{ echo '-';}?>
                </td>
                <td>
                    <?php echo $ad['objective_for_cost'];?>
                </td>
                <td>
                    <?php if(isset($ad['insights'])){echo $ad[ 'insights'][ 'data'][0][ 'spend'];}else{ echo '-';}?>
                </td>
                <td>Ongoing-</td>
                <td>
                    <?php if(isset($ad['insights'])){echo $ad[ 'insights'][ 'data'][0][ 'relevance_score'][ 'score'];}else{ echo '-';}?>
                </td>
                <td>
                    <?php if(isset($ad['insights'])){echo $ad[ 'insights'][ 'data'][0][ 'frequency'];}else{ echo '-';}?>
                </td>
                <td>
                    <?php if(isset($ad['insights'])){echo $ad[ 'insights'][ 'data'][0][ 'impressions'];}else{ echo '-';}?>
                </td>
                <td>
                    <?php if(isset($ad['insights'])){echo $ad[ 'insights'][ 'data'][0][ 'unique_clicks'];}else{ echo '-';}?>
                </td>
                <td>
